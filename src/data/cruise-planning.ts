...
export const cruisePlanningPages: GuidePage[] = [
  ...
  },
  {
    ...
    overview: "Corfu pairs UNESCO Old Town walkability with island drives to Paleokastritsa beaches and Achilleion Palace — different geography from fjord-like Kotor.",
  ...
  },
  {
    ...
    highlights: ["Kotor — fjord arrival, walkable walls", "Dubrovnik — ramparts and cable car", "Corfu — beaches and palaces"],
