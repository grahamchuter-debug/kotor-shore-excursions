  ...
  return (
    <section className="section-padding bg-coastal-50 border-t border-coastal-100">
      <div className="container-wide">
        <p className="section-eyebrow">Mediterranean cruise planning</p>
        <h2 className="section-title mt-2">Plan your wider Mediterranean cruise</h2>
        <p className="section-subtitle">
          Kotor is often one stop on an Adriatic or Eastern Mediterranean itinerary — explore our sister planning resources.
        </p>
        ...
        <div className="mt-6">
          <Link href="/guides" className="btn-secondary text-sm">All Kotor planning guides</Link>
        </div>
      </div>
    </section>
  );
