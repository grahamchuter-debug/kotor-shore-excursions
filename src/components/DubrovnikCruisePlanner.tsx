...
export function KotorCruisePlanner() {
  ...
  const [interests, setInterests] = useState<string[]>(["old-town", "city-walls"]);
  ...
  function downloadPdf() {
    ...
    doc.save("kotor-cruise-plan.pdf");
  }
  ...
  return (
    <div className="card-feature">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button type="button" onClick={generate} className="btn-primary">Build my Kotor plan</button>
