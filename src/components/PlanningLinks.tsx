...
const LINKS = [
  ...
  { href: "/ship-schedules/kotor", label: "Ship Schedules" },
  { href: "/compare/blue-cave-vs-perast", label: "Compare" },
  { href: "/faq", label: "FAQ" },
];

export function PlanningLinks({ heading = "Keep planning your Kotor cruise" }: { heading?: string }) {
  return (
